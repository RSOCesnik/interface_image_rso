...
public class CatalogServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().write("<div class=\"image-form\"><form method=\"post\" action=\"/app/addimage\" enctype=\"multipart/form-data\">" +
        ...
        if (data == null || data.isEmpty()) {
            ...
            for (ImageDto image : ppl2) {
                ...
                response.getWriter().write("<a href=\"app/image/"+image.getId()+"\"><img src=\"" + image.getData() + "\" data-id=\"" + image.getId() + "\"  /></a><br/>");
